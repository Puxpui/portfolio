...
function App() {
  ...
  return (
    <div id='home'>
      <MyNavbar />
      <div className='font-dcscrip bg-white'>
        ...
        <MyMotion direction="up" delay={0.2}>
          <div className='flex justify-center'>
            <div className='mt-[10%] text-xl font-semibold text-[#666666]'>
        ...
        <MyMotion direction="up" delay={0.2}>
          <div className='flex justify-center' id='about'>
            <div className='mt-[12%] text-4xl font-semibold'>About Me</div>
          </div>
        </MyMotion>
        <MyMotion direction="up" delay={0.2}>
        ...
        <MyMotion direction="up" delay={0.2}>
          <div className='flex justify-center'>
            <div className='mt-[5%] text-4xl font-semibold'>Education</div>
          </div>
        </MyMotion>
        <MyMotion direction="up" delay={0.2}>
        ...
        <MyMotion direction="up" delay={0.2}>
          <div className='flex justify-center' id='certificate'>
            <div className='mt-[12%] text-4xl font-semibold'>Certificate</div>
          </div>
        </MyMotion>
        <MyMotion direction="up" delay={0.2}>
          <div className='flex justify-center'>
        ...
        <MyMotion direction="up" delay={0.2}>
          <div className='flex justify-center' id='contact'>
            <div className='mt-[12%] text-4xl font-semibold'>Contact</div>
          </div>
        </MyMotion>
        <MyMotion direction="up" delay={0.2}>
